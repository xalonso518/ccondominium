...
import { CuotaTabla } from 'src/app/models/cuota/cuotaTabla';
import { ConstantsCatalogos } from 'src/app/utils/constants/ConstantsCatalogos';
import { ChartsModule } from 'ng2-charts';

@Component({
  selector: 'app-grafica-cuota',
  templateUrl: './grafica-cuota.component.html',
  styleUrls: ['./grafica-cuota.component.css'],
  providers: [CuotaService, ErrorValidationService, ConfigService],
  animations: [slideInDownAnimation, listAnimation]
})
export class GraficaCuotaComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<GraficaCuotaComponent>,
  ...
  public barChartData: any[] = [
    { data: this.totales, label: 'Cuotas' },
  ];
